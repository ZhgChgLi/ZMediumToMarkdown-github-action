...
![Photo by Glenn Carstens-Peters](images/41c49a75a743/1*RU89TcfRAR5mmclMX9x57w.jpeg "Photo by Glenn Carstens-Peters")
### 緣由
...
![](images/41c49a75a743/1*k2OHjrcQaQIWLqV7G57TgA.png "")
...
5. Build！成功！
![](images/41c49a75a743/1*74osParg9RRi2gcRx9ELuw.png "")
...
```
![](images/41c49a75a743/1*rwq_KZIDW-Lvtpd2xmgjDw.png "")
![](images/41c49a75a743/1*BCKtqshZxHH17j3nBGtNlg.png "")

然後再回頭到 Build Phases 更改 Script 內容路徑成執行檔

EX: `${SRCROOT}/Localize`

![](images/41c49a75a743/1*ewhCXzXNuS0MCTMCuINWng.png "")
...
```
![](images/41c49a75a743/1*TPLS60W1iQiGFzU-inf3aA.png "")
...
_p.s 假設圖片是動態變數提供，檢查工具將無法識別，可將其加入_ `ignoredUnusedNames` _中設為例外。_
...
_P.S 可以看到程式碼出現_ `localizedStrings()` _命名，懷疑作者是從語系檢查工具的邏輯搬來用，忘了改方法名稱ＸＤ_
