...
多個漏洞合併引起的網站資安問題
![Photo by Tarik Haiga](images/142244e5f07a/1*EQPani1J-PTO-ccp588gBg.jpeg "Photo by Tarik Haiga")
### 前言

幾年前還有在邊支援網頁開發的時候；被指派任務要為公司內部工程組舉辦 CTF 競賽；一開始初想是依照公司產品分組互相攻防入侵，但身為主辦，為了想先瞭解掌握程度就先對公司旗下各產品進行入侵測試；看看我自己能找到幾個漏洞，確保活動流程不會出問題。
> _但最後因為比賽時間有限、工程區別差異太大；所以最後以工程共通基礎知識及有趣的方向出題，有興趣的朋友可參考我之前的文章「_[**_如何打造一場有趣的工程CTF競賽_**](%E5%A6%82%E4%BD%95%E6%89%93%E9%80%A0%E4%B8%80%E5%A0%B4%E6%9C%89%E8%B6%A3%E7%9A%84%E5%B7%A5%E7%A8%8Bctf%E7%AB%B6%E8%B3%BD-729d7b6817a4)_」；裡面有很多腦洞大開的題目！_
### 找到的漏洞
...
### 漏洞重現方式
![](images/142244e5f07a/1*ILb0VdnkAvgH5aW7qos_lg.png "")
...
以上兩個操作都會寄出重設密碼驗證信。
![](images/142244e5f07a/1*sPNp2NfoykG8-m3vWociQQ.png "")
...
```
![](images/142244e5f07a/1*nfAhh3QasOLCDxdxH5jEQg.png "")

`6EqfSZLqDc` 顯示出 `5136` 。

那把我們的密碼重設 Token 塞進去會怎樣？管他的！ **塞塞看！**

![](images/142244e5f07a/1*9BccKKQMxdqgtqlad13Ghg.png "")
> Bingo!
...
立刻打開來看看：
![個人資料頁](images/142244e5f07a/1*VLoCTluycBbW70QplV50Lw.png "個人資料頁")
![網頁原始碼部分](images/142244e5f07a/1*cb0Rpz_Zuto5e6WTPsA_Tw.png "網頁原始碼部分")
 ...
 **一樣管他的！塞爆！** 
![](images/142244e5f07a/1*mQVMT-D8avyeYSYp5VBU8w.png "")
> Bingo!🥳🥳🥳
> `PvrrbQWBGDQ3LeSBByd` _=_ `2395656`
####  **反解出重設密碼令牌，發現是數字之後** 
...
>  **_再來只需要想辦法將_** `2395657` **_換回 Token 令牌即可！_** 
#### 好巧不巧又發現個問題
>  **_網站在編輯資料時的信箱格式驗證只有前端驗證，後端並未二次驗證格式是否正確…_** 

繞過前端驗證後，將信箱改為下一位目標
![](images/142244e5f07a/1*tdqRy5N0k8WS85l8u8CbKw.png "")
![](images/142244e5f07a/1*PRTZJZuv7DG11CoUn5OHQg.png "")
> Fire in the hole!
...
![](images/142244e5f07a/1*1kZp5LQ1yT6m7IBJLoYj9Q.png "")
> 入侵成功！繞過驗證重設他人密碼！
