...
![](images/e77b80cc6f89/1*-luP3wtJr1XJ9Vq3M0sQLA.png "")
### 成果
![Pinkoi iOS Team 實拍圖](images/e77b80cc6f89/1*gJhRllB0sQb-W3P7tQAQ6g.jpeg "Pinkoi iOS Team 實拍圖")
...
![](images/e77b80cc6f89/1*ABFLOY1AEKkSJah6EVJEkg.png "")
...
![](images/e77b80cc6f89/1*K0got1UinY2y4cFxZ2HM3w.jpeg "")

點擊右上方的「Query」可開啟帶有輔助 SQL Builder 的介面(如對 SQL 不熟建議使用這個)：
![](images/e77b80cc6f89/1*fxget7SOAb7hlnKDWhvmFQ.jpeg "")

或直接點「COMPOSE NEW QUERY」開一個空白的 Query Editor：
![](images/e77b80cc6f89/1*3T7vHuR4LoojnZ5xe6LWfg.png "")

不管是哪種方法，都是同個文字編輯器；在輸入完 SQL 之後可以預先在右上方自動完成 SQL 語法檢查和預計會花費的查詢額度(`This query will process XXX when run.`)：

![](images/e77b80cc6f89/1*wGMkfqGPg277BzuUgOag1w.jpeg "")
...
LIMIT 
  10;
```
![](images/e77b80cc6f89/1*YtbpV4tm0Z_iwrOA0AJ9Jg.jpeg "")
...
```
> _如果不知道怎麼取得 in-cming WebHook URL 可以參考_[_此篇文章_](%E9%81%8B%E7%94%A8-google-apps-script-%E8%BD%89%E7%99%BC-gmail-%E4%BF%A1%E4%BB%B6%E5%88%B0-slack-d414bdbdb8c9)_的「取得 Incoming WebHooks App URL」章節。_
#### 測試＆設定排程
![](images/e77b80cc6f89/1*epwnVrltY7ei8_osPnbaww.jpeg "")
...
![](images/e77b80cc6f89/1*Pt-falvO3uCtfSrJpNZeZQ.png "")

 **執行測試一次沒問題後，可以開始設定排程自動執行：** 
![](images/e77b80cc6f89/1*-lI8vcewsS5ZRt5vR1iAkg.jpeg "")

於左方選擇鬧鐘圖案，再選擇右下方「+ Add Trigger」。
![](images/e77b80cc6f89/1*V20eoW30mHYnHkhUk5uKnw.png "")
...
### 完成
![範例成果圖](images/e77b80cc6f89/1*J4k9SMFX8hU7-M_zX3wDtw.jpeg "範例成果圖")
