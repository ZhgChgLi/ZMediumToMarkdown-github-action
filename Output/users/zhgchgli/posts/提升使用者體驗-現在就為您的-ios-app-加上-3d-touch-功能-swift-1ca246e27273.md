...
![1. Preview ViewController 預覽功能 — 結婚吧APP](images/1ca246e27273/1*Nl6uz_dA2h13g7PtqSi6aw.gif "1. Preview ViewController 預覽功能 — 結婚吧APP")
![2. 3D Touch Shortcut APP 捷徑啟動功能](images/1ca246e27273/1*VcIEwZxiW26eVqCk4kUEZw.gif "2. 3D Touch Shortcut APP 捷徑啟動功能")
...
![附圖1 背景虛化保留區示意圖](images/1ca246e27273/1*AAFevro2x7s9J6yRshAGtg.png "附圖1 背景虛化保留區示意圖")

如果您需要上滑後在下方加入選項選單請在 **B** 之中加入，是B 是B 是B哦！

![](images/1ca246e27273/1*L7VwD_lyG86eXzTzgIuELQ.png "")
```Swift
...
![](images/1ca246e27273/1*PlbW5bVYGkN2olZC9WAvHw.png "")
- UIApplicationShortcutItemIconType : 使用系統圖標

![參考自此篇文章](images/1ca246e27273/1*S3dbMWNnTvhdt-NlxAQ2Tw.png "參考自此篇文章")
...
![我的設定如上圖](images/1ca246e27273/1*cIIVrNDdziBVJn4z_QsLJg.png "我的設定如上圖")
#### 第二步
...
#### p.s.
![如果你測的夠細會發現以上效果，在CollectionView滑動中圖有部分已經滑出畫面這時按壓就會出現以上情況😅](images/1ca246e27273/1*LBgSqm8CTdBPycGnuYNMkA.png "如果你測的夠細會發現以上效果，在CollectionView滑動中圖有部分已經滑出畫面這時按壓就會出現以上情況😅")
