...
![真香梗](images/33afa0ae557d/1*EbKTh7BihiHMiYx5IKIHzA.gif "真香梗")
### 入手背景
...
![ΛVICII ◢ ◤ — 官方預覽圖](images/33afa0ae557d/1*Mq5OL0FPCng7aWCk7WuIZQ.png "ΛVICII ◢ ◤ — 官方預覽圖")
...
![](images/33afa0ae557d/1*pDMA_4el8K9jM9ICPhw2DQ.png "")
### 開箱！

[![YouTube](images/33afa0ae557d/057a_hqdefault.jpg "YouTube")](http://www.youtube.com/watch?v=vgvTTq37lDs)
![外包裝](images/33afa0ae557d/1*BsAop5tLLCTzvOr20PljCg.jpeg "外包裝")
![展開](images/33afa0ae557d/1*ZcmitKF70mHUgT0Z9JKl0g.jpeg "展開")
![本體近照](images/33afa0ae557d/1*drdMA2Be4tknViLR302sPg.jpeg "本體近照")
![本體全身照](images/33afa0ae557d/1*-ILMv-qhWVqw2wJMjgDs3A.jpeg "本體全身照")
![肚子裡的東西](images/33afa0ae557d/1*9b88eDk92tmU6GakEY1Hig.jpeg "肚子裡的東西")

亂開箱結束！整體拿起來有份量，手感跟質感非常好，刻字部分也很精細；是蘋果產品該有的水準！
### 使用
#### 第一次使用：
![](images/33afa0ae557d/1*GdIZpl46uQiX50zIkoLSjw.jpeg "")

全新AirPods第一次使用時只需打開 AirPods盒子 靠近 iPhone 就會詢問，即可完成配對；不用特別案配對按鈕。
#### 設定耳機操作：

 **手機版：** 
![打開「設定」->「藍芽」->「找到你的AirPods」->「設定」](images/33afa0ae557d/1*Aktq6bFF9dDTfWXxrUSQTA.jpeg "打開「設定」->「藍芽」->「找到你的AirPods」->「設定」")

 **MacBook 版：** 
![左上角「」->「系統偏好設定」->「藍芽」(若沒聲音請將聲音書出改選AirPods)](images/33afa0ae557d/1*lkDI9yIkdo1X-FmqAftxpA.jpeg "左上角「」->「系統偏好設定」->「藍芽」(若沒聲音請將聲音書出改選AirPods)")

可自行選擇左右耳的雙擊的動作．

 **點擊位置在耳機本體上側邊小孔下方：** 
![其實我摸索了一下才知道位置](images/33afa0ae557d/1*Mm_AMBVgSu6KhflqIOkNGg@2x.jpeg "其實我摸索了一下才知道位置")
#### 一些小技巧

 **快速切換回iPhone上使用：** 
![上拉選單->選擇音訊區塊->選擇右上圖標->切換選擇AirPods](images/33afa0ae557d/1*WAp5lJK3JPqsKEY6tX840g.jpeg "上拉選單->選擇音訊區塊->選擇右上圖標->切換選擇AirPods")

也可由此查看AirPods電量。（顯示電量較低的那隻的電量）

 **用小工具查看電量方法：** 
![左滑到控制中心->下方「編輯」->找到「電池」新增並排序](images/33afa0ae557d/1*CvQhTsxObgHlso2DfbQLTg.jpeg "左滑到控制中心->下方「編輯」->找到「電池」新增並排序")

以後就能直接左滑控制中心查看AirPods電量（顯示電量較低的那隻的電量）要看左右耳及盒子的電量，就需將其中一隻AirPods放回盒子並打開盒子（因為盒子本身沒有藍芽功能）：
![*盒子內是我貼的防塵貼片](images/33afa0ae557d/1*qoUfpf1Jh_jVrHN_l3QRew.jpeg "*盒子內是我貼的防塵貼片")
> 這裡有一個BUG，如果你的電池小工具顯示電量一下之後就消失；請去「設定」->「螢幕顯示與亮度」->「文字大小」-> 調回預設大小（第三格）即可！

 **Apple Watch 查看電量方法：** 
![上滑控制中心->點擊電量](images/33afa0ae557d/1*A7ZVJoLehIN14J0LM5Y3qA.jpeg "上滑控制中心->點擊電量")
...
### 使用心得
![](images/33afa0ae557d/1*vlDbOyPlOGtttbTXf-Q_IA.jpeg "")
...
[![YouTube](images/33afa0ae557d/7645_hqdefault.jpg "YouTube")](http://www.youtube.com/watch?v=XD8Lvp1vR1M)

 **小開箱：** 
![正面，因為怕髒所以我買深色](images/33afa0ae557d/1*Lw1clUAV8LkY9BmFN5LqBg.jpeg "正面，因為怕髒所以我買深色")
![背面也有相對應配對鍵的按鈕](images/33afa0ae557d/1*5qO-NZPG1EO1XtYG-oCJyQ.jpeg "背面也有相對應配對鍵的按鈕")
![拿收耳機只需翻開上半部](images/33afa0ae557d/1*gI9dn0sq2HzRo2Q5wjTN5A.jpeg "拿收耳機只需翻開上半部")
![底部充電孔有蓋子可開關](images/33afa0ae557d/1*BJKzNjJeASWYHr9pDjzoQQ.jpeg "底部充電孔有蓋子可開關")
...
#### 再來是盒子內部防塵貼：
![AHA AirPods 防塵貼](images/33afa0ae557d/1*mgL_FMaH5So-U0iAGJsVFg.jpeg "AHA AirPods 防塵貼")
...
![詐騙、來源不明的賣家](images/33afa0ae557d/1*IypsLTNMK79I2qaODhL7rw.jpeg "詐騙、來源不明的賣家")
...
#### 亦或是1代當2代賣？
![二代外盒圖](images/33afa0ae557d/1*PgsrH6zlNX6tMzI3IxUnGQ.jpeg "二代外盒圖")
...
[![YouTube](images/33afa0ae557d/ba98_hqdefault.jpg "YouTube")](http://www.youtube.com/watch?v=7TgWMEa1gH0)

[![YouTube](images/33afa0ae557d/5ec5_hqdefault.jpg "YouTube")](http://www.youtube.com/watch?v=E-PqwL69-bs)
### 來個全家桶吧
![](images/33afa0ae557d/1*NY3kXQ32tNEK3TpkKXp3zw.jpeg "")
...
| **[View original post on Medium](https://medium.com/zrealm-life/airpods-2-%E9%96%8B%E7%AE%B1%E5%8F%8A%E4%B8%8A%E6%89%8B%E9%AB%94%E9%A9%97%E5%BF%83%E5%BE%97-33afa0ae557d) - Converted by [ZhgChgLi](https://blog.zhgchg.li)/[ZMediumToMarkdown](https://github.com/ZhgChgLi/ZMediumToMarkdown)** |
